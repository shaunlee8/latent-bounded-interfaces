...
from backbones.mamba2.utils.torch import custom_bwd, custom_fwd
...
from backbones.mamba2.ops.triton.ssd_bmm import _bmm_chunk_fwd, _bmm_chunk_bwd
from backbones.mamba2.ops.triton.ssd_chunk_state import _chunk_cumsum_fwd, _chunk_cumsum_bwd
from backbones.mamba2.ops.triton.ssd_chunk_state import _chunk_state_fwd, _chunk_state_bwd_db
from backbones.mamba2.ops.triton.ssd_chunk_state import _chunk_state_bwd_ddAcs_stable
from backbones.mamba2.ops.triton.ssd_chunk_state import chunk_state, chunk_state_ref
from backbones.mamba2.ops.triton.ssd_chunk_state import chunk_state_varlen
from backbones.mamba2.ops.triton.ssd_state_passing import _state_passing_fwd, _state_passing_bwd
from backbones.mamba2.ops.triton.ssd_state_passing import state_passing, state_passing_ref
from backbones.mamba2.ops.triton.ssd_chunk_scan import _chunk_scan_fwd, _chunk_scan_bwd_dz, _chunk_scan_bwd_dstates
from backbones.mamba2.ops.triton.ssd_chunk_scan import _chunk_scan_bwd_dC, _chunk_scan_bwd_dcb
from backbones.mamba2.ops.triton.ssd_chunk_scan import _chunk_scan_bwd_ddAcs_stable
from backbones.mamba2.ops.triton.ssd_chunk_scan import chunk_scan, chunk_scan_ref
from backbones.mamba2.ops.triton.ssd_chunk_scan import _chunk_scan_bwd_ddAcs_prev
from backbones.mamba2.ops.triton.layernorm_gated import rmsnorm_fn, _layer_norm_fwd, _layer_norm_bwd
from backbones.mamba2.ops.triton.k_activations import _swiglu_fwd, _swiglu_bwd
from backbones.mamba2.utils.determinism import (
...
def ssd_selective_scan(x, dt, A, B, C, D=None, z=None, dt_bias=None, dt_softplus=False, dt_limit=(0.0, float("inf"))):
    ...
    try:
        ...
        raise ImportError(
            "ssd_selective_scan requires mamba_ssm.ops.selective_scan_interface, "
            "which is not part of the minimal LBI Mamba-2 extraction"
        ) from exc
